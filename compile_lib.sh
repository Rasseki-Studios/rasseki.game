...
ar rcs libAdapter.a matrix.o libAdapter.o surface.o location.o item.o event.o event_factory.o event_parser.o artifact.o storage.o artifact_factory.o artifact_parser.o mapscanner.o movable.o hero.o EasyBMP.o items_data.o session_data.o
