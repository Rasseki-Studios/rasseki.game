g++ -g -O2 $1 --std=c++17 -c libAdapter.cpp surface.cpp location.cpp item.cpp event.cpp event_factory.cpp event_parser.cpp artifact.cpp storage.cpp artifact_factory.cpp artifact_parser.cpp mapscanner.cpp movable.cpp hero.cpp libs/EasyBMP/EasyBMP.cpp items_data.cpp session_data.cpp -lstdc++fs
