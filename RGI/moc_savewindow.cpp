...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_SaveWindow_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 33, 0)
    ...
    "SaveWindow\0on_backSaving_clicked\0\0"
};
...
void SaveWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->on_backSaving_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObject SaveWindow::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_SaveWindow.data,
      qt_meta_data_SaveWindow,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_SaveWindow.stringdata))
        return static_cast<void*>(const_cast< SaveWindow*>(this));
